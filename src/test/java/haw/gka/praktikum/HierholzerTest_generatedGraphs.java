 ...
 * - pos. und neg. Tests
 * TODO hier fehlt noch der erweiterte Aufruf für die Übergabe des Parameters
 * even
 */
public class HierholzerTest_generatedGraphs {
    ...
    void test_modifiedGenerator_evenDegrees() throws IOException {
        GraphModel genGraph = generator.generateGraph(8, 12);

        GraphModel actual_eulerkreis = hierholzer.searchEulerCircle(genGraph);
    ...
    void test_100edges_32nodes() throws IOException {
        GraphModel genGraph = generator.generateGraph(32, 100);
    ...
    void test_300edges_64nodes() throws IOException {
        GraphModel genGraph = generator.generateGraph(64, 300);
    ...
    void test_1000edges_128nodes() throws IOException {
        GraphModel genGraph = generator.generateGraph(128, 1000);
    ...
    void test_3000edges_256nodes() throws IOException {
        GraphModel genGraph = generator.generateGraph(256, 3000);
    ...
    void test_10_000edges_512nodes() throws IOException {
        GraphModel genGraph = generator.generateGraph(512, 10_000);
    ...
    void test_30_000edges_1024nodes() throws IOException {
        GraphModel genGraph = generator.generateGraph(1024, 30_000);
    ...
    void test_100_000edges_2048nodes() throws IOException {
        GraphModel genGraph = generator.generateGraph(2048, 100_000);
    ...
    void test_300_000edges_4096nodes() throws IOException {
        GraphModel genGraph = generator.generateGraph(4096, 300_000);
    ...
    void test_1_000_000edges_8192nodes() throws IOException {
        GraphModel genGraph = generator.generateGraph(8192, 1_000_000);
    ...
    void test_3_000_000edges_16_384nodes() throws IOException {
        GraphModel genGraph = generator.generateGraph(16_384, 3_000_000);
    ...
    void test_10_000_000edges_32_768nodes() throws IOException {
        GraphModel genGraph = generator.generateGraph(32_768, 10_000_000);
